...
export function ViewFullPatient({ patient, onOpenChange }: FullDetails) {
 ...
 const handleDownloadImage = async () => {
  ...
  if(!isMobile){
          ...
          <div className="mt-4 grid grid-cols-3 gap-4">
            ...
            <div className="col-span-1 border border-gray-300 rounded shadow-sm">
              ...
              <div className="p-4 grid grid-cols-1 gap-3 text-sm">
                <Field label="Patient Name" value={`${fields.firstName} ${fields.lastName}`} />
            ...
            <div className="col-span-1 border border-gray-300 rounded shadow-sm">
              ...
              <div className="p-4 grid grid-cols-1 gap-3 text-sm">
                ...
                <Field label="Respiratory Rate" value={fields.respiratoryRate || ""} />
                <Field label="Temperature" value={fields.temperature || ""} />
                <Field label="Oxygen Saturation" value={fields.oxygenSaturation || ""} />
              </div>
            </div>
            ...
            <div className="col-span-1 border border-gray-300 rounded shadow-sm">
              ...
              <div className="p-4 text-sm space-y-4">
                <div>
                  <label className="font-semibold">Past Illnesses / Chronic Conditions:</label>
                ...
                <div>
                  <label className="font-semibold">Surgeries & Hospitalizations:</label>
                  <div className="border border-gray-300 p-2 rounded min-h-[60px]">
                    {/* {fields.surgeries || ""} */}
                  </div>
                </div>
    ...
    <div className="mt-4">
            <Button onClick={handleDownloadImage} className="bg-indigo-700 text-white hover:bg-indigo-800">
      ...
      >
        ...
        <div className="mt-4 mb-6">
          ...
          <div className="p-4 text-sm space-y-4">
            ...
            <div>
              <label className="font-semibold">Surgeries & Hospitalizations (with dates):</label>
              <div className="border border-gray-300 p-2 rounded min-h-[60px]">
                {/* {fields.surgeries || ""} */}
              </div>
            </div>
